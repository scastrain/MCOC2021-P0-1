...
def graficar(nombres):
    ...
    for nombre in nombres:
        ...
        plt.subplot(2,1,1)
        plt.title("Complejidad Inv Dispersa")
...
nombres= ["Complejidad_INV_dispersa0.txt","Complejidad_INV_dispersa1.txt","Complejidad_INV_dispersa2.txt","Complejidad_INV_dispersa3.txt"]
graficar(nombres)
