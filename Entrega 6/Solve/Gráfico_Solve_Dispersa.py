...
def graficar(nombres):
    ...
    for nombre in nombres:
        ...
        plt.subplot(2,1,1)
        plt.title("Complejidad Solve Dispersa")
...
nombres= ["Complejidad_SOLVE_dispersa0.txt","Complejidad_SOLVE_dispersa1.txt","Complejidad_SOLVE_dispersa2.txt","Complejidad_SOLVE_dispersa3.txt"]
graficar(nombres)
