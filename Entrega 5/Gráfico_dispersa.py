...
nombres= ["Complejidad_MATMUL_llena0.txt","Complejidad_MATMUL_llena1.txt","Complejidad_MATMUL_llena2.txt","Complejidad_MATMUL_llena3.txt","Complejidad_MATMUL_llena4.txt","Complejidad_MATMUL_llena5.txt","Complejidad_MATMUL_llena6.txt","Complejidad_MATMUL_llena7.txt","Complejidad_MATMUL_llena8.txt","Complejidad_MATMUL_llena9.txt"]
graficar(nombres) 
