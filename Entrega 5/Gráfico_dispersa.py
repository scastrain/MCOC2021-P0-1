...
def graficar(nombres):
    ...
    for nombre in nombres:
        ...
        plt.subplot(2,1,1)
        plt.title("Complejidad MATMUL dispersa")
...
nombres= ["Complejidad_MATMUL_dispersa0.txt","Complejidad_MATMUL_dispersa1.txt","Complejidad_MATMUL_dispersa2.txt","Complejidad_MATMUL_dispersa3.txt","Complejidad_MATMUL_dispersa4.txt","Complejidad_MATMUL_dispersa5.txt","Complejidad_MATMUL_dispersa6.txt","Complejidad_MATMUL_dispersa7.txt","Complejidad_MATMUL_dispersa8.txt","Complejidad_MATMUL_dispersa9.txt"]
graficar(nombres) 
